        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <router-link to="" class="nav-item nav-link"><i class="emoji bi bi-building-fill"></i>지점 리스트</router-link>
                    <router-link to="" class="nav-item nav-link"><i class="emoji bi bi-door-open-fill"></i>객실</router-link>
                    <router-link to="" class="nav-item nav-link active"><i class="emoji bi bi-pin-map-fill"></i>부대 시설</router-link>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->

        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <router-link to="/customerList" class="nav-item nav-link"><i class="emoji bi bi-people-fill"></i>고객 리스트</router-link>
                    <router-link to="/" class="nav-item nav-link active"><i class="emoji bi bi-person-fill-add"></i>고객 등록</router-link>
          </div>
            </nav>
        </div>
        <!-- Sidebar End -->
...
<div class="container-fluid pt-4 px-4">
          <div class="bg-secondary rounded-top p-4">
            ...
            <div class="form-submit">
              <button type="submit" class="btn-submit">등록</button><br /><br />
            </div>
            <form @submit.prevent="handleSubmit">
              <div class="form-group">
                <div class="half">
                  <label for="korean-name">한글 이름:</label>
                  <input type="text" id="korean-name" v-model="form.koreanName" />
                </div>
              ...
              <div class="form-group">
                ...
                <input type="text" id="address" v-model="form.address" style="width: 500px;" />
              </div>
            </form>
          </div>
        </div>
